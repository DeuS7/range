...
function turnGameOn() {
	//Should not be here. Just development.
	drawTarget();
...
function startGame() {
	...
	//Should be in start game;
	//And finish it in endGame;
...
/*function highlightShots() {
	var shots = document.getElementsByClassName("shotHole");
	var xCenter, yCenter;
	var coord;

	for (var i = 0;i<shots.length;i++) {
		coord = shots[i].getBoundingClientRect();
		xCenter = coord.left - shotHoleDimension/2;
		yCenter = coord.top + shotHoleDimension/2;
