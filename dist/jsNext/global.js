...
var comments = {
	...
	farewell: [["Get by!", "It's okay. I'm not angry.", "Good Riddance!"], 2],
	hint: [["press space to shoot", "Don't eat yellow snow"]],
	misfire: [["Misfire!"], 2],
	refr: [["The game is refreshed"]],
	restr: [["The game is on!"]],
	quick: [["u always so quick?"]]
}